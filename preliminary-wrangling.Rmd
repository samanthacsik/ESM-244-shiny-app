...
# not sure what this is but copying from An's code below
ca_merge <- ca_districts

# try merging ca_districts with school enrollment
school_enrollment_merge <- school_enrollment %>% 
  dplyr::select(COUNTY, DISTRICT, SCHOOL) %>% 
  rename(county_name = COUNTY) %>% 
  unique()

district_schools <- merge(school_enrollment_merge, ca_merge)
